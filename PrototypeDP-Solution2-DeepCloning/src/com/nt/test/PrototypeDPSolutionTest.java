...
public class PrototypeDPSolutionTest {
	...
	public static void main(String[] args) {
		...
		//any modification done in  original obj or clonned object will not be reflected to other object
		//becoz  we taken the support of deep cloning
		   ...
		   System.out.println("orginal object data::"+fictionalBooks); //does not reflects here
